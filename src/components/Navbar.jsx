                ...
                <div>
                    ...
                    {!isTabletOrMobile || navbarOpen ?
                        <ul className={isTabletOrMobile ? 'gap-4' : 'flex gap-4 items-center'}>
                            ...
                            <li>Cara Booking</li>
                            <li>Kontak</li>
                            <li className='border-2 p-2 bg-white rounded-md cursor-pointer' onClick={() => navigate('/login')}>Masuk</li>
                            <li className='bg-[#FF5B24] text-white p-2 rounded-md cursor-pointer' onClick={() => navigate('/register')}>Daftar</li>
                        </ul> : null
                    }
                </div>
            }
